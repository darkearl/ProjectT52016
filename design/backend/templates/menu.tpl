...
<div class="navbar-admin-top">
    ...
    <div class="navbar navbar-inverse" id="header_navbar">
        ...
        {if "ULTIMATE"|fn_allowed_for}
            {assign var="storefront_is_promo" value="ULTIMATE:FREE"|fn_allowed_for}
            <div class="nav-ult">
                ...
                {if $runtime.companies_available_count > 1}
                    ...
                    {capture name="extra_content"}
                        {if fn_check_view_permissions("companies.manage", "GET")}
                            <li class="divider"></li>
                            <li><a href="{"companies.manage?switch_company_id=0"|fn_url}"{if $storefront_is_promo} class="cm-promo-popup"{/if}>{__("manage_stores")}...</a></li>
                        {/if}
                    {/capture}
                        ...
                        {else}
                            {if fn_check_view_permissions("companies.manage", "GET")}
                                <li class="dropdown vendor-submenu">
                                    <a class="dropdown-toggle{if $storefront_is_promo} cm-promo-popup{/if}" {if !$storefront_is_promo}data-toggle="dropdown"{/if}>
